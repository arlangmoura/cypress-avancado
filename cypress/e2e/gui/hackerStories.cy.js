    ...
    context('Footer and list of stories', () => {
      ...
      context('List of stories', () => {
        it('shows the right data for all rendered stories', () => {
          cy.fixture('stories.json').then((stories) => {
            cy.get('.item')
              .first()
              .should('be.visible')
    ...
    context('Search', () => {
      ...
      context('Last searches', () => {
        it('shows a max of 5 buttons for the last searched terms', () => {
          ...
          /** escrita antiga do código acima
...
//verifica que não é necessário um it está dentro de um context ou describe para funcionar
